...
export const AuthProvider = ({ children }) => {
    ...
    const Signup_URL = "https://jobportaldashboard-server.onrender.com/api"
    const Job_URL = "https://jobportaldashboard-server.onrender.com/api/jobs"
    const Company_URL = "https://jobportaldashboard-server.onrender.com/api/company"
    const Alumini_URL = "https://jobportaldashboard-server.onrender.com/api/alumini"
